...
// GEMM for Q4_0 weights using simdgroup matrix multiply-accumulate.
//
...
void dequantize_q4_0(device const block_q4_0 * xb, short il, thread half4x4 & reg) {
...
kernel void gemm_q4_0(
    ...
    device const block_q4_0 * x = (device const block_q4_0 *)(src0
